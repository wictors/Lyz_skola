...
public class MysqlHodinaDaoTest {
    ...
    public void testPridajHodinu() {
        ...
        List<Hodina> hodiny = daoH.podlaDatumu("2016-12-13");
        MysqlInstruktorDao daoI = new MysqlInstruktorDao(ObjectFactory.INSTANCE.getJdbcTemplate());
        List<Instruktor> instruktori = daoI.podlaPriezviska("Dvorak");
        ...
        hodina.setDatum("2016-12-13");
        daoH.pridajHodinu(hodina);
        List<Hodina> noveHodiny = daoH.podlaDatumu("2016-12-13");
